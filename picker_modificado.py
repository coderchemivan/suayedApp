...
class MDDatePicker(BaseDialogPicker):
    ...
    def update_calendar(self, year, month):
        try:
            ...
            for idx in range(len(self._calendar_list)):
                ...
                if self._calendar_list[idx].text in lista_days:
                ...
                # ) == self._current_selected_date or self._calendar_list[idx].text in lista_days:
    ...
    def set_selected_widget_modificado(self,widget):
        if self._sel_day_widget:
            self._sel_day_widget.is_selected = False
        ...
        if primer_dia_del_mes == 0:
            suma = -1
        elif primer_dia_del_mes ==1:
            suma =0
        elif primer_dia_del_mes ==2:
            suma =1
        elif primer_dia_del_mes ==3:
            suma =2
        elif primer_dia_del_mes ==4:
            suma =3
        elif primer_dia_del_mes ==5:
            suma =4
        else:
            suma = 5
        ...
        for day in lista_days:
            x = int(day)+suma
            self._calendar_list[x].is_selected = True
